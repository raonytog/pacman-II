...
typedef struct tMapa{
    ...
    /* Tempo restante para explodir a bomba */
    int tempoRestanteExplodirBomba;
...
/**
 * Ativa a bomba e começa a contagem regressiva de 3 movimentos.
 * \param mapa mapa
 */
void AtivaBombaMapa(tMapa* mapa);

/**
 * Decrementa a contagem regressiva de 3 movimentos para explodir a bomba 
 * e retorna a posição da explosão da bomba. Caso a bomba ainda não tenha 
 * explodido, ou não tenha bomba no mapa, retorna NULL;
 * \param mapa mapa
 */
void DecrementaContagemRegressivaBombaMapa(tMapa* mapa);
