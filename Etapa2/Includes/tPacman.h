...
typedef struct tPacman{
    ...
    /* Quantidade de movimentos restantes que o pacman pode atravessar parede */
    int nMovimentosRestantesAtravessaParede;

    /* Quantidade de movimentos restantes que o pacman pode matar um fantasma ao encostar */
    int nMovimentosRestantesMatarFantasma;
...
/**
 * Retorna o número atual de movimentos restantes que o pacman pode matar um fantasma
 * 
 * \param pacman pacman
 */
int ObtemNumeroMovimentosRestantesMatarFantasmaPacman(tPacman* pacman);

/**
 * Retira o poder de matar fantasmas do pacman
 * 
 * \param pacman pacman
 */
void RetiraMataFantasmaPacman(tPacman* pacman);
